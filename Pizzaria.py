...
# ---------------- Bloco 2 — Inserção com proteção contra duplicação ----------------
...
# Popular cardápio inicial (não duplica por causa do UNIQUE + IntegrityError)
...
if menu == "Início":
    ...
    if not produtos:
        ...
        if st.session_state["carrinho"]:
            ...
            # Atualiza produtos para mapear corretamente
